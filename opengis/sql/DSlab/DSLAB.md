...
To allow for a scalable and interactive visualization of this analysis, I have made a [leaflet web map](leaflet/dsmmap/index.html). I have also provided some basic directions on how to publish a web map from qgis in the [following blog post](osgis/leaflet/leaflet.md).
